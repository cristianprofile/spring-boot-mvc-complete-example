...
import com.mylab.cromero.cromero.repository.EspecialidadRepository;
...
@SpringApplicationConfiguration(classes = {ConfigurationRepository.class,TestRepositoryConfigIT.class})
@Transactional
